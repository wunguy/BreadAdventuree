...
bool WinScene::init()
{
    ...
    keyboardListener->onKeyPressed = CC_CALLBACK_2(WinScene::keyPressed, this);
    keyboardListener->onKeyReleased = CC_CALLBACK_2(WinScene::keyReleased, this);
    ...
    auto label = Label::createWithTTF("You Win", "fonts/Marker Felt.ttf", 99);
    if (label == nullptr)
    {
...
void WinScene::keyPressed(cocos2d::EventKeyboard::KeyCode keyCode, cocos2d::Event* event)
{

}
void WinScene::keyReleased(cocos2d::EventKeyboard::KeyCode keyCode, cocos2d::Event* event)
{
