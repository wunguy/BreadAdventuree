...
//USING_NS_CC;
//
//Scene* GameSce2::createScene()
//{
//	auto scene = Scene::createWithPhysics();
//	scene->getPhysicsWorld()->setDebugDrawMask(PhysicsWorld::DEBUGDRAW_NONE);
//	scene->getPhysicsWorld()->setGravity(Vec2(0, -980));
//	auto layer = GameSce2::create();
...
//	_hero->Stand();
//	this->addChild(_hero);
//	this->schedule(CC_SCHEDULE_SELECTOR(GameSce2::UpdateEventKey, this));
//	//contact
//
//
//
...
//	ListenerContact->onContactBegin = CC_CALLBACK_1(GameSce2::onContact, this);
//	_eventDispatcher->addEventListenerWithSceneGraphPriority(ListenerContact, this);
//	//Pause
//	auto keyboardListener = EventListenerKeyboard::create();
//	keyboardListener->onKeyPressed = CC_CALLBACK_2(GameSce2::keyPressed, this);
//	keyboardListener->onKeyReleased = CC_CALLBACK_2(GameSce2::keyReleased, this);
//
...
//}
//
//bool GameSce2::onContact(PhysicsContact& contact)
//{
...
//};
//
//void GameSce2::UpdateEventKey(float dt)
//{
...
//
//}
//void GameSce2::keyPressed(cocos2d::EventKeyboard::KeyCode keyCode, cocos2d::Event* event)
//{
//
//	InputKey::getInstance()->onKeyPresses((int)keyCode);
//
//}
//void GameSce2::keyReleased(cocos2d::EventKeyboard::KeyCode keyCode, cocos2d::Event* event)
//
//{
...
//
//
//void GameSce2::menuCloseCallback(Ref* pSender)
//{
